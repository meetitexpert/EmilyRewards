...
export class HomeScreenComponent {
  ...
  ngOnInit(){
    ...
    let promotionsArray = [promotion1, promotion2, promotion1, promotion2, promotion1, promotion2]
  ...
  getFavouriteRetailer(){
    ...
    this.apiService.post(this.constatns.getFavouriteRetailer, params).subscribe((response)=>{
      ...
      // this.favouriteRetailers.offers?.push(this.favouriteRetailers.offers[0])
      // this.favouriteRetailers.offers?.push(this.favouriteRetailers.offers[0])
      // this.favouriteRetailers.offers?.push(this.favouriteRetailers.offers[0])
    })
  }
